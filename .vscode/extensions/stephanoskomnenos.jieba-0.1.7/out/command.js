...
exports.selectWord = exports.backwardKillWord = exports.killWord = exports.backwardWord = exports.forwardWord = void 0;
...
async function backwardKillWord() {
    const editor = vscode.window.activeTextEditor;
    if (editor === undefined) {
        return;
    }
...
function findFirstNonSpace(text) {
    return text.search(/[^\s]/);
}
function findLastNonSpace(text) {
...
function findFirstSpaceAfterNonCJK(text) {
...
function findLastSpaceBeforeNonCJK(text) {
...
function findWordStartPosition(cursor) {
