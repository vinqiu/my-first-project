...
* @returns {any[]}
*/
module.exports.cut = function(text, hmm) {
    try {
...
* @returns {any[]}
*/
module.exports.cut_all = function(text) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        var ptr0 = passStringToWasm0(text, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        var len0 = WASM_VECTOR_LEN;
...
* @returns {any[]}
*/
module.exports.cut_for_search = function(text, hmm) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        var ptr0 = passStringToWasm0(text, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        var len0 = WASM_VECTOR_LEN;
...
* @returns {any[]}
*/
module.exports.tokenize = function(text, mode, hmm) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        var ptr0 = passStringToWasm0(text, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        var len0 = WASM_VECTOR_LEN;
...
* @returns {number}
*/
module.exports.add_word = function(word, freq, tag) {
...
const path = require('path').join(__dirname, 'jieba_rs_wasm_bg.wasm');
